...
import panelistRoutes from './routes/panelists.js';
import qualifierRoutes from './routes/qualifiers.js';
...
app.use('/panelists', panelistRoutes);
app.use('/qualifiers', qualifierRoutes);
